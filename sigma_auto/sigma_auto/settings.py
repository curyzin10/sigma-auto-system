"""
Django settings for sigma_auto project.
...
SECRET_KEY = 'django-insecure-8gdlxa%wkg_19j#xbnveoi!v-7i#(0m#k(gzm*n(tqs@p3y5$$'
...
WSGI_APPLICATION = 'sigma_auto.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'sigma_auto_data',  # Nome do banco de dados
